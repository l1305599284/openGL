...
glm::mat4 computeMatricesFromInputs(GLFWwindow* window, glm::mat4& inViewMatrix, glm::mat4& inProjectionMatrix) {
    // 获取时间间隔
    ...
    // 摄像机上向量Up vector : perpendicular to both direction and right
